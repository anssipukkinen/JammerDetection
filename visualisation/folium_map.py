...
# Create DataFrame
df = pd.read_csv('data/output_all_pos.csv')
...
# Save map to HTML
m.save('visualisation/animated_map_with_agc_snr_all_data2.html')

# Add custom CSS to the saved file to style tooltips
with open('visualisation/animated_map_with_agc_snr_all_data2.html', 'r') as file:
    content = file.read()
...
with open('visualisation/animated_map_with_agc_snr_all_data2.html', 'w') as file:
    file.write(content)
