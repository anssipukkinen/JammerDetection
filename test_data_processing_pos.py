...
import pandas as pd
import numpy as np
from data_processing_pos import (
    parse_agc_file,
    parse_nmea_file,
    parse_pos_file,
    process_files,
...
class TestDataProcessing(unittest.TestCase):
    def setUp(self):
        ...
        self.pos_file = 'pos-sample-test.data'  # Updated to use test data file
    ...
    def test_parse_pos_file(self):
        ...
        self.assertEqual(len(df), 54)  # Number of data rows in pos-sample-test.data
