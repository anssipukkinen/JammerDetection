...
def gpst_to_unix(gpst_str):
    ...
    dt = datetime.strptime(gpst_str, "%Y/%m/%d %H:%M:%S.%f").replace(tzinfo=timezone.utc)
...
if __name__ == "__main__":
    # Process the files
    process_files('data/source/agc.csv', 'data/source/gnss_log_2024_09_10_14_21_50.nmea', 'data/source/gnss_log_2024_09_10_14_21_50.pos', 'data/source/output_all_pos_orig.csv')
